...
---
# Acerca de este blog
Este es mi blog personal y, ya que suelo escribir a mano, usa la fuente [Excalifont](https://plus.excalidraw.com/excalifont) para casi todos los textos. El diseño fue inspirado y basado en la página web de [Steph Ango](https://stephango.com/). Está creado con [Astro](https://astro.build/) y [Tailwind](https://tailwindcss.com/).
